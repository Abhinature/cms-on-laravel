    ...
    <div class="card">
        <table class="card-body table">
            ...
            <tbody>
                ...
                <td> <a href="{{ route('dashboard.redirectPath', ['tableName' => Crypt::encrypt($val['table_name'])]) }}" class="btn btn-small btn-primary">View</a></td>
