                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody> @php
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="align-middle text-center text-sm">
                                    <a href="{{route('edit-dynamic-page',['id' => Crypt::encrypt($dt->id)])}}" class="btn btn-primary">Edit</a>     
                                    @if($dt->submit_for_review == 0)
                                    <a href="{{route('submit-review',['id' => Crypt::encrypt($dt->id)])}}" class="btn btn-primary">Submit For Review</a> 
                                    @endif
                                    </td>
