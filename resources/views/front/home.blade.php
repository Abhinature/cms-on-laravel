...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    <div class="carousel-indicators">
        @php 
        $asx = count($sliderImage);
        @endphp
        <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="{{$asx}}" @class(['active'=> ($asx == 0)]) aria-current="true" aria-label="Slide {{$asx}}"></button>
    ...
    <div class="row p-2">
        ...
        <div class="col-lg-4 col-md-4 mb-3">
            <div class="card shadow card-fixed-height">
                ...
                <div class="card-body slick-slider scroll">
