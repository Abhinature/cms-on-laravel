                ...
                <div class="card-body"> 
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="page-tab-pane" role="tabpanel" aria-labelledby="page-tab" tabindex="0">
                            ...
                            <div class="form-group">
                                <input type="text" name="hi_name" id="" class="form-control" />
                            </div>
                            ...
                            <div class="form-group">
                                <textarea name="page_css" class="form-control"></textarea>
                            </div>

                            <label for="name">Page JS</label>
                            <div class="form-group">
                                <textarea name="page_js" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="english-tab-pane" role="tabpanel" aria-labelledby="english-tab" tabindex="0">
                            ...
                            <div class="form-group">
                                <input type="text" name="heading_en" id="" class="form-control" />
                            </div>

                            <label for="name">Content</label>
                            <div class="form-group">
                                <textarea name="main_content_en" class="form-control editor"></textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="hindi-tab-pane" role="tabpanel" aria-labelledby="hindi-tab" tabindex="0">
                            ...
                            <label for="name">Title</label>
                            <div class="form-group">
                                <input type="text" name="title_hi" id="" class="form-control" />
                            </div>

                            <label for="name">Heading</label>
                            <div class="form-group">
                                <input type="text" name="heading_hi" id="" class="form-control" />
                            </div>

                            <label for="name">Hindi Content</label>
                            <div class="form-group">
                                <textarea name="main_content_hi" class="form-control editor"></textarea>
                            </div>
                        </div>
                    </div>
