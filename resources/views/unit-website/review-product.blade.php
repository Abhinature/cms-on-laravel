      ...
      <div class="table-responsive">
        <table class="table table-striped text-center">
          ...
          <tbody>
            ...
            <tr>
              <th>{{$a = $a+1;}}</th>
              <th>{{$wp->product_name}}</th>
              <th><img style="max-width:80px;" src="{{$wp->product_image}}"/></th>
              <th>{!!$wp->product_specification!!}</th>
              <th>
                <a class="btn btn-success" href="{{route('approve-product',['id'=>$wp->id])}}">Approve</a> | 
